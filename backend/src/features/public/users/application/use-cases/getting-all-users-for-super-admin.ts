...
export class GettingAllUsersForSuperAdminUseCase
    implements ICommandHandler<GettingAllUsersForSuperAdminCommand>
{
    constructor(
    ...
    async execute(command: GettingAllUsersForSuperAdminCommand) {
        const paginationCriteria: paginationCriteriaType =
            this.common.getPaginationCriteria(command.queryParams);
